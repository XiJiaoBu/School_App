...
class Day8 extends StatelessWidget {
  ...
  void _toDay8(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(builder: (context) => Day8Page()));
  }
}


class Day8Page extends StatelessWidget {
  const Day8Page({ Key? key }) : super(key: key);
                            ...
                            child: Column(
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    displayAnnounce[7].announcement,
                                    style: TextStyle(
                                      fontSize: 18,
                                    ),
                                  ),
