...
class Day4 extends StatelessWidget {
  ...
  void _toDay4(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(builder: (context) => Day4Page()));
  }
}
