...
class Day5 extends StatelessWidget {
  ...
  void _toDay5(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(builder: (context) => Day5Page()));
  }
}


class Day5Page extends StatelessWidget {
  const Day5Page({ Key? key }) : super(key: key);
