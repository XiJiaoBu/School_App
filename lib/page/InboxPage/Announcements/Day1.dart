...
class Day1 extends StatelessWidget {
  ...
  void _toDay1(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(builder: (context) => Day1Page()));
  }
}
