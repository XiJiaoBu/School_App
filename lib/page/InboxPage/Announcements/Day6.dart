...
class Day6 extends StatelessWidget {
  ...
  void _toDay6(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(builder: (context) => Day6Page()));
  }
}
