...
class Day7 extends StatelessWidget {
  ...
  void _toDay7(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(builder: (context) => Day7Page()));
  }
}


class Day7Page extends StatelessWidget {
  const Day7Page({ Key? key }) : super(key: key);
