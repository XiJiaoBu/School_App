...
class Day2 extends StatelessWidget {
  ...
  void _toDay2(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(builder: (context) => Day2Page()));
  }
}
